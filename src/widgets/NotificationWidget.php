...
use fatfish\notification\assetbundles\notificationwidgetwidget\NotificationWidgetWidgetAsset;
...
class NotificationWidget extends Widget
{
    ...
    {
        return Craft::t('notification', 'NotificationWidget');
    }
    ...
    {
        return Craft::getAlias("@fatfish/notification/assetbundles/notificationwidgetwidget/dist/img/NotificationWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'notification/_components/widgets/NotificationWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(NotificationWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'notification/_components/widgets/NotificationWidget_body',
            [
